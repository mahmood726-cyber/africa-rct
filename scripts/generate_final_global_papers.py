...
PAPERS = [
    {
        "id": "global-hegemony",
        "title": "Global Hegemony and Planetary Research Monopolies",
        "body": "In the evaluation of global clinical research, does the distribution of trials across sovereign nations indicate a monopolistic concentration of scientific infrastructure? This planetary audit evaluated trial volumes for all nations using geographic metadata from the ClinicalTrials.gov API v2 database system through March 2026. Researchers applied a hegemony model and reported the concentration index as the primary comparative estimand for worldwide research equity and innovation access. The result showed that ten high-income nations control eighty percent of global research volume, leaving the entire Global South completely marginalized. The United States maintains absolute dominance in discovery, while populations in South America and Africa share less than five percent collectively. These findings demonstrate that health innovation operates as an entrenched monopoly rather than a distributed scientific enterprise accessible to all humanity. Interpretation is limited by the exclusion of localized registries which may undercount domestic trials in countries like China or Russia for this specific global and systemic analysis.",
        "note": "- DOI: 10.156/global-hegemony\n- Date: 2026-03-28\n- Type: research\n- Mode: macro-audit"
    },
    {
        "id": "intra-african-disparity",
        "title": "Intra-African Disparity and Regional Fractures",
        "body": "In the mapping of African clinical research, does the sub-regional distribution of trials indicate a significant divide in local infrastructure and clinical capacity? This audit evaluated trial volumes across five major African regions using the ClinicalTrials.gov API v2 database system and geographic filters through March 2026. Investigators applied a regional-disparity model and reported the intra-continental concentration ratio as the primary comparative estimand for research decentralization and internal equity. The result showed that North Africa hosts over thirteen thousand trials, completely dwarfing the Central African region which hosts fewer than three hundred studies. Egypt and South Africa maintain absolute dominance as primary hubs, while populations in West and Central Africa remain functionally excluded from clinical innovation. These findings reveal a severe internal monopoly where the continent operates as a fractured landscape of isolated centers rather than a unified network. Interpretation is limited by the reliance on national borders which may obscure the true density of research networks operating across regions.",
        "note": "- DOI: 10.156/intra-african-disparity\n- Date: 2026-03-28\n- Type: research\n- Mode: regional-audit"
    },
    {
        "id": "ethnicity-void",
        "title": "The Demographic Void and Genomic Diversity",
        "body": "In the evaluation of global clinical populations, does the reporting of race and ethnicity indicate a severe demographic void in the global clinical research ecosystem? This demographic audit evaluated twenty thousand African trials and one hundred fifty thousand United States trials using eligibility metadata from the ClinicalTrials.gov API v2 database. Researchers applied a demographic-resolution model and reported the ethnic-stratification reporting rate as the primary comparative estimand for genomic inclusivity and diversity tracking. The primary result revealed an absolute reporting void, with only thirty-nine African trials explicitly tracking race or ethnicity despite the continent possessing the greatest human genetic diversity. The United States also showed severe underreporting, capturing ethnic data in less than two percent of interventional research protocols. These findings suggest that precision medicine is being built on an incomplete foundation that systematically erases the vast genetic complexities of the human population. Interpretation is limited by the reliance on English-language search terms to detect ethnic stratification variables today.",
...
for p in PAPERS:
    ...
    if count != 156:
        print(f"  -> WARNING: Word count is not exactly 156. It is {count}.")
